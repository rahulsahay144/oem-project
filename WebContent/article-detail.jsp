			   ...
			   <%
					...
					while(rt.next()) {
						 out.print(String.format("<tr>" +
	                             ...
	                             "<td>%s</td>" +
	                         "</tr>",
	                         rt.getString(1), rt.getString(2), rt.getString(3), rt.getString(4), rt.getString(5) == null ? "" : "<a href='' onClick='javascript:openArticle(\"article_" + id + "\")'>View</a>", "<a href='deletearticle?id=" + rt.getString(1) + "'>Delete</a>"));
